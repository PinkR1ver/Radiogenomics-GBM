...
T2WeightPath = os.path.join(modelPath, 'T2_unet.pth')
savePath = os.path.join(dataPath, 'train_monitor_image_AX')
predictPath = os.path.join(dataPath, 'test_image_AX')

if __name__ == '__main__':
    fullTrainDataset = Train_T2_AX_ImageDataset(dataPath,'GBM_MRI_Dataset.csv')
    ...
    net = UNet().to(device)
    if os.path.exists(T2WeightPath):
        net.load_state_dict(torch.load(T2WeightPath))
    ...
    f = open(os.path.join(modelPath, 'T2_epoch.txt'), "r") 
    epoch = int(f.read())
    f.close()
    ...
    for iter_out in range(300):
        ...
        for i, (image, segmentImage) in enumerate(trainLoader):
            ...
            if i % 50 == 0:
                torch.save(net.state_dict(), T2WeightPath)
            ...
            torchvision.utils.save_image(testImage, os.path.join(savePath, 'T2', f'{i}.png')) 
        ...
        if epoch % 5 == 0:
            ...
            with torch.no_grad():
                for i, (image, segmentImage) in enumerate(testLoader):
                    ...
                    testImage = torch.stack([_image, _segmentImage, _outImage], dim=0)
                    torchvision.utils.save_image(testImage, os.path.join(predictPath, 'T2', f'{i}.png'))
            ...
            plt.savefig(os.path.join(predictPath, 'T2', 'test_loss_monitor', f'test_times_{int(epoch/5)}_TestLoss.png'))
            ...
            plt.savefig(os.path.join(predictPath, 'T2', 'test_sensitivity_monitor', f'test_times_{int(epoch/5)}_Sensitivity.png'))
            ...
            plt.savefig(os.path.join(predictPath, 'T2', 'test_specificity_monitor', f'test_times_{int(epoch/5)}_Specificity.png'))
            ...
            f = open(os.path.join(predictPath, 'T2', 'test_sensitivity_monitor', 'log.txt'), "a")
            f.write(f'test times {int(epoch/5)}:\n')
            ...
            f = open(os.path.join(predictPath, 'T2', 'test_specificity_monitor', 'log.txt'), "a")
            f.write(f'test times {int(epoch/5)}:\n')
        ...
        plt.savefig(os.path.join(savePath, 'T2', 'train_loss_monitor', f'epoch{epoch}_TrainLoss.png'))
        ...
        plt.legend(title='sensitivity', loc='upper right', labels='sensitivity')
        plt.savefig(os.path.join(savePath, 'T2', 'train_sensitivity_monitor', f'epoch{epoch}_Sensitivity.png'))
        ...
        plt.legend(title='specificity', loc='upper right', labels='specificty')
        plt.savefig(os.path.join(savePath, 'T2', 'train_specificity_monitor', f'epoch{epoch}_Specificity.png'))
        ...
        f = open(os.path.join(savePath, 'T2', 'train_sensitivity_monitor', 'log.txt'), "a")
        f.write(f'epoch{epoch}:\n')
        ...
        f = open(os.path.join(savePath, 'T2', 'train_specificity_monitor', 'log.txt'), "a")
        f.write(f'epoch{epoch}:\n')
        ...
        if epoch % 20 == 0:
            ...
            plt.legend(title='sensitivity', loc='upper right', labels='sensitivity')
            plt.savefig(os.path.join(savePath, 'T2', 'train_sensitivity_monitor', f'epoch{epoch-19}_epoch{epoch}_Sensitivity.png'))
            ...
            plt.legend(title='specificity', loc='upper right', labels='specificty')
            plt.savefig(os.path.join(savePath, 'T2', 'train_specificity_monitor', f'epoch{epoch-19}_epoch{epoch}_Specificity.png'))
        ...
        if epoch % 100 == 0:
            ...
            plt.legend(title='sensitivity', loc='upper right', labels='sensitivity')
            plt.savefig(os.path.join(predictPath, 'T2', 'test_sensitivity_monitor', f'Already epoch{epoch}_Sensitivity.png'))
            ...
            plt.legend(title='specificity', loc='upper right', labels='specificty')
            plt.savefig(os.path.join(predictPath, 'T2', 'test_specificity_monitor', f'Already epoch{epoch}_Specificity.png'))
