...
'''
This block is to design MSRF-Net, Multi-Scale Residual Fusion Network
Author:https://github.com/NoviceMAn-prog/MSRF-Net
Copied by https://github.com/amlarraz/MSRF-Net_PyTorch/blob/master/msrf.py
'''

class DSDF_block(nn.Module):  
...
class SPATIALATT_block(nn.Module):    
