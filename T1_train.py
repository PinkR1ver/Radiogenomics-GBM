...
if __name__ == '__main__':
    ...
    for iter_out in range(300):
        ...
        if epoch % 5 == 0:
            ...
            plt.legend(title='test loss', loc='upper right', labels='test loss')
            plt.savefig(os.path.join(predictPath, 'T1', 'test_loss_monitor', f'test_times_{int(epoch/5)}_TestLoss_sort.png'))
            ...
            plt.legend(title='sensitivity', loc='upper right', labels='sensitivity')
            plt.savefig(os.path.join(predictPath, 'T1', 'test_sensitivity_monitor', f'test_times_{int(epoch/5)}_Sensitivity_sort.png'))
            ...
            plt.legend(title='specificity', loc='upper right', labels='specificty')
            plt.savefig(os.path.join(predictPath, 'T1', 'test_specificity_monitor', f'test_times_{int(epoch/5)}_Specificity_sort.png'))
        ...
        plt.legend(title='train loss', loc='upper right', labels='train loss')
        plt.savefig(os.path.join(savePath, 'T1', 'train_loss_monitor', f'epoch{epoch}_TrainLoss_sort.png'))
        ...
        plt.legend(title='sensitivity', loc='upper right', labels='sensitivity')
        plt.savefig(os.path.join(savePath, 'T1', 'train_sensitivity_monitor', f'epoch{epoch}_Sensitivity_sort.png'))
        ...
        plt.legend(title='specificity', loc='upper right', labels='specificty')
        plt.savefig(os.path.join(savePath, 'T1', 'train_specificity_monitor', f'epoch{epoch}_Specificity_sort.png'))
